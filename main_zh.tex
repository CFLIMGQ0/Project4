...
\caption{四个胃镜数据集的原始与重平衡标签共现矩阵。各列依次展示WLE、染色胃镜、手术胃镜和EUS的分布。上排为原始检查分布，下排为每个数据集中五个独立重平衡训练集汇总后的累积分布；验证集和测试集均未重平衡，也未纳入汇总。每个单元格给出相应数量和百分比。对角线单元格表示各标签的边际阳性频数，非对角线单元格表示两两共阳性频数。百分比以对应原始数据集或汇总训练曝光为基数计算。SMT表示食管黏膜下肿瘤，EML表示食管黏膜病变。\label{fig:label_cooccurrence}}
\end{figure*}
...
\hline
模型 & 图像 & 文本 & WLE & 染色胃镜 & 手术胃镜 & EUS & CT-RATE \\
\hline
Attention MIL & $\checkmark$ & $\times$ & \tresult{0.7919}{0.0119} & \tresult{0.7391}{0.0448} & \tresult{0.7018}{0.1235} & \tresult{0.6268}{0.0342} & \tresult{0.4338}{0.0232} \\
Mean pooling & $\checkmark$ & $\times$ & \tresult{0.7931}{0.0088} & \tresult{0.7408}{0.0322} & \tresult{0.7173}{0.0744} & \tresult{0.5910}{0.0592} & \tresult{0.4255}{0.0265} \\
Transformer-context MIL & $\checkmark$ & $\times$ & \tresult{0.8004}{0.0160} & \tresult{0.7426}{0.0194} & \tresult{0.7765}{0.0886} & \tresult{0.5966}{0.0612} & \tresult{0.4215}{0.0196} \\
Top-$k$ MIL & $\checkmark$ & $\times$ & \tresult{0.7862}{0.0232} & \tresult{0.7511}{0.0406} & \tresult{0.7698}{0.0849} & \tresult{0.6037}{0.0887} & \tresult{0.4364}{0.0196} \\
Max pooling & $\checkmark$ & $\times$ & \tresult{0.7608}{0.0034} & \tresult{0.6842}{0.0261} & \tresult{0.6009}{0.0919} & \tresult{0.5505}{0.0756} & \tresult{0.4270}{0.0267} \\
TransMIL & $\checkmark$ & $\times$ & \tresult{0.8021}{0.0146} & \tresult{0.7217}{0.0368} & \tresult{0.7516}{0.0938} & \tresult{0.6045}{0.0539} & \tresult{0.4358}{0.0190} \\
DSMIL & $\checkmark$ & $\times$ & \tresult{0.7956}{0.0159} & \tresult{0.7468}{0.0448} & \tresult{0.6873}{0.0852} & \tresult{0.5765}{0.0765} & \tresult{0.4379}{0.0218} \\
DTFD-MIL & $\checkmark$ & $\times$ & \tresult{0.7714}{0.0141} & \tresult{0.7091}{0.0306} & \tresult{0.7134}{0.0853} & \tresult{0.5896}{0.0419} & \tresult{0.4394}{0.0167} \\
CLAM-MB & $\checkmark$ & $\times$ & \tresult{0.7741}{0.0090} & \tresult{0.7137}{0.0269} & \tresult{0.7094}{0.0865} & \tresult{0.5883}{0.0401} & \tresult{0.4424}{0.0136} \\
CLAM-SB & $\checkmark$ & $\times$ & \tresult{0.7642}{0.0040} & \tresult{0.6997}{0.0234} & \tresult{0.6785}{0.0479} & \tresult{0.5695}{0.0379} & \tresult{0.4398}{0.0110} \\
\hline
Hashed mean & $\times$ & $\checkmark$ & \tresult{0.8901}{0.0184} & \tresult{0.8037}{0.0689} & \tresult{0.8349}{0.0187} & \tresult{0.8836}{0.0688} & \tresult{0.6191}{0.0293} \\
Vocabulary attention & $\times$ & $\checkmark$ & \tresult{0.8906}{0.0124} & \tresult{0.8045}{0.0708} & \tresult{0.8147}{0.0487} & \tresult{0.8957}{0.0542} & \tresult{0.7334}{0.0315} \\
TextCNN & $\times$ & $\checkmark$ & \tresult{0.9004}{0.0123} & \tresult{0.8652}{0.0332} & \tresult{0.8356}{0.0807} & \tresult{0.8982}{0.0515} & \tresult{0.6888}{0.0615} \\
BiGRU & $\times$ & $\checkmark$ & \tresult{0.8928}{0.0191} & \tresult{0.8085}{0.0818} & \tresult{0.8075}{0.0342} & \tresult{0.9019}{0.0531} & \tresult{0.6369}{0.0186} \\
Transformer & $\times$ & $\checkmark$ & \tresult{0.8915}{0.0163} & \tresult{0.8150}{0.0281} & \tresult{0.8285}{0.0174} & \tresult{0.8830}{0.0604} & \tresult{0.7750}{0.0259} \\
\hline
MMFNet (2024)\cite{R29}$^{\dagger}$ & $\checkmark$ & $\checkmark$ & \tresult{0.9132}{0.0099} & \tresult{0.8371}{0.0647} & \tresult{0.8345}{0.0844} & \tresult{0.8999}{0.0731} & \tresult{0.5734}{0.0237} \\
RadFuse (2025)\cite{R32}$^{\dagger}$ & $\checkmark$ & $\checkmark$ & \tresult{0.9135}{0.0083} & \tresult{0.7990}{0.1013} & \tresult{0.8221}{0.0671} & \tresult{0.8517}{0.0712} & \tresult{0.6788}{0.0439} \\
SAIF (2025)\cite{R30}$^{\dagger}$ & $\checkmark$ & $\checkmark$ & \tresult{0.8413}{0.0166} & \tresult{0.7201}{0.0544} & \tresult{0.7482}{0.0821} & \tresult{0.6266}{0.0986} & \tresult{0.4481}{0.0200} \\
MMTF (2026)\cite{R31}$^{\dagger}$ & $\checkmark$ & $\checkmark$ & \tresult{0.9121}{0.0118} & \tresult{0.7320}{0.0415} & \tresult{0.7595}{0.1371} & \tresult{0.7846}{0.0974} & \tresult{0.7779}{0.0402} \\
\hline
AMEF-MIL (Ours) & $\checkmark$ & $\checkmark$ & \tresult{\textbf{0.9149}}{\textbf{0.0114}} & \tresult{\textbf{0.8877}}{\textbf{0.0168}} & \tresult{\textbf{0.8456}}{\textbf{0.0224}} & \tresult{\textbf{0.9064}}{\textbf{0.0474}} & \tresult{\textbf{0.8134}}{\textbf{0.0186}} \\
\hline
\end{tabular}
}
...
在大部分数据集上，纯文本模型的性能明显高于纯图像MIL方法，其中EUS上的差距最大。这说明在检查级弱监督条件下，胃镜所见描述包含的目标相关信息明显多于图像序列，同时也提示可能存在语义标签泄漏。尽管最终标签经过临床审核，且直接类别表述已被掩码，病灶形态和位置描述仍可能较强地暗示相应诊断。相比之下，经过多模态分支监督与知识蒸馏后，辅助纯图像分支在四个数据集上的性能均接近表现最好的纯文本模型，并在WLE上实现超越。这一对比表明，有序图像序列本身保留了充分的判别信息，多模态训练能够帮助视觉路径获取互补的疾病相关语义，视觉模态也对最终预测作出了实质性贡献。
...
原始胃镜图像和临床报告数据由于可能包含敏感临床信息，并受两家参与医院的数据治理要求约束，因此不公开提供。经去标识化的衍生数据表可在合理请求且获得两家医院许可后向通讯作者获取。

\subsection*{代码可用性}

AMEF-MIL的实现、训练与评估源码已公开发布于\href{https://github.com/CFLIMGQ0/AMEF-MIL}{https://github.com/CFLIMGQ0/AMEF-MIL}（v1.0.0版本）。
