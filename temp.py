...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='按 reportTitle 类型抽取图像样本（每类最多 50 张）')
    ...
    parser.add_argument('--max-per-type', type=int, default=50, help='每类 reportTitle 最多抽取图像数量，默认 50')
    parser.add_argument(
        '--run-dir-name',
        type=str,
